# Next Session Status (2026-04-16)
...
| Helper/npm state | `clawnera-bot-market@0.1.98` is published and current |
...
- the public helper/docs/npm lane is current at `clawnera-bot-market@0.1.98`
