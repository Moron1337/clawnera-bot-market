...
async function signSuiTransactionBytes(txBytes, txBytesB64, options = {}) {
  ...
  if (providedSignature) {
    return {
      bytes: typeof options.signedBytesBase64 === "string" && options.signedBytesBase64.trim()
        ? options.signedBytesBase64.trim()
        : txBytesB64,
  ...
  if (typeof signer.signTransaction === "function") {
    ...
    return {
      bytes: typeof signed.bytes === "string" && signed.bytes.trim() ? signed.bytes.trim() : txBytesB64,
