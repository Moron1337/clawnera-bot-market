...
export async function buildDisputeSupplementalBundlePayload({
  ...
  const payload = {
    ...
    orderId: assertCanonicalProtocolString(orderId, "order_id", MAX_MANIFEST_ORDER_ID_BYTES),
    milestoneId: assertCanonicalProtocolString(milestoneId, "milestone_id", MAX_MANIFEST_MILESTONE_ID_BYTES),
    assignmentRound: Number(assignmentRound),
    evidenceClass: assertCanonicalProtocolString(evidenceClass, "evidence_class", 64),
    declaredByActorAddress: normalizeAddress(declaredByActorAddress, "declared_by_actor_address"),
    ...(replyToEvidenceId ? { replyToEvidenceId: assertCanonicalProtocolString(replyToEvidenceId, "reply_to_evidence_id", 64) } : {}),
...
export function normalizeDisputeSupplementalBundlePayload(payload) {
  ...
  return {
    ...
    assignmentRound: Number(payload.assignmentRound),
    evidenceClass: assertCanonicalProtocolString(payload.evidenceClass, "evidence_class", 64),
    ...
    ...(payload.replyToEvidenceId
      ? { replyToEvidenceId: assertCanonicalProtocolString(payload.replyToEvidenceId, "reply_to_evidence_id", 64) }
      : {}),
