...
function listingDepositPaymentAndRefs(tx, req) {
    ...
    const listingDepositConfigObjectId = assertValidIotaObjectId(req.listingDepositConfigObjectId, "listing_deposit_config_object_id");
    const depositAmount = assertPositiveAmount(req.depositAmount, "deposit_amount");
...
//# sourceMappingURL=listingDeposit.js.map